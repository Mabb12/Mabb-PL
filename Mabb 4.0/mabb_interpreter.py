            ...
            try:
                ...
                if token_type == 'NEWLINE':
                    ...
                    if token_value == '_PRINT': # Команда вывода в консоль
                        ...
                        break
                    elif token_value == '_IF': # Команда для проверки, выполнено ли условие
                        self._if()
                    else:
                        self.pc += 1
                else:
...
if __name__ == "__main__":
    code = """
_VAR _INPUT sum = 'Введите число'
_VAR _INPUT move = 'Введите действие +/-'
_VAR _INPUT sum2 = 'Введите число'
_VAR _NUMBER output = 0

_IF move == '+'
    _OPERATION output = sum + sum2
_ENDIF
